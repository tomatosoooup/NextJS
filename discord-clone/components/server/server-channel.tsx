...
export const ServerChannel = ({
  ...
  return (
    ...
    >
      ...
      <p
        className={cn(
          "line-clam-1 font-semibold text-sm text-zinc-500 group-hover:text-zinc-600 dark:text-zinc-400 dark:group-hover:text-zinc-300 transition",
          params?.channelId === channel.id &&
            "text-primary dark:text-zinc-600 dark:group-hover:text-white"
        )}
      >
        {channel.name}
      </p>
