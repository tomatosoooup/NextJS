export const isColumnOfFour = (
  newBoard: string[],
  boardSize: number,
  formulaForColomnOfFour: number
) => {
  for (let i: number = 0; i < formulaForColomnOfFour; i++) {
...
export const isColumnOfThree = (
  newBoard: string[],
  boardSize: number,
  formulaForColomnOfThree: number
) => {
  for (let i: number = 0; i < formulaForColomnOfThree; i++) {
