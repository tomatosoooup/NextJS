...
const Footer = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center lg:grid lg:grid-cols-4 mt-10 lg:mt-2 px-5 lg:px-0">
        ...
        <div className="order-2 lg:order-none relative">
          ...
          <div className="flex gap-10 lg:gap-2 text-[#D9D9D9] text-sm font-bold">
            <div
              className="flex-grow flex flex-col gap-1 text-center lg:text-left"
              style={{ fontFamily: `${fonts.ct}` }}
            >
              <span>Wrocław</span>
            ...
            <div
              className="flex-grow  flex flex-col gap-1 pl-2 text-center lg:text-left"
              style={{ fontFamily: `${fonts.ct}` }}
            >
              <span>Poznań</span>
        ...
        <div className="lg:ml-20 order-3  lg:order-none">
          ...
          <div className="flex lg:flex-col gap-20 lg:gap-5">
            <p
              className="text-[#D9D9D9] text-base font-light"
              style={{ fontFamily: `${fonts.ct}` }}
            >
        ...
        <div className="lg:ml-10 order-1 lg:order-none">
          ...
          <div
            className="flex lg:flex-col text-white/70 text-sm gap-10 font-light lg:gap-2"
            style={{ fontFamily: `${fonts.ct}` }}
          >
      ...
      <div
        className="text-center mt-8 lg:mt-12 mb-3 text-white/50 text-sm font-light"
        style={{ fontFamily: `${fonts.tt}` }}
      >
